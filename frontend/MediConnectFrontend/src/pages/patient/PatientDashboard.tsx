...
//     setAiResult(
//       "Aapke symptoms — " + symptomText + " — dekhte hue, ye seasonal flu ya viral infection ho sakti hai. Paracetamol 500mg lein, paani ziada piyein, aur 2-3 din mein theek na hon to doctor se zaroor milen. Ye AI suggestion hai — professional advice nahi."
//     );
//     setAiLoading(false);
//   };
...
//     if (!isListening) {
//       setTimeout(() => {
//         setSymptomText("Sar dard, bukhar aur khansee ho rahi hai");
...
//     >
//       {/* ─── SIDEBAR ─── */}
//       <aside className={`w-[240px] flex-shrink-0 hidden xl:flex flex-col h-screen sticky top-0 ${t.sidebar} border-r ${t.sidebarBorder}`}>
//         {/* Logo */}
...
//             </div>
//             <div>
//               <h1 className="text-white text-lg font-bold tracking-tight">MediConnect</h1>
//               <p className="text-[#4A6080] text-xs">Patient Portal</p>
//             </div>
//           </div>
//         </div>
...
//             <p className="text-white text-xs font-semibold">Portal Active</p>
//             <p className="text-[#4A6080] text-xs">{formatTime(currentTime)}</p>
//           </div>
//         </div>
...
//           <p className="text-[#2D4A6A] text-[10px] font-bold uppercase tracking-widest px-3 mb-3 mt-6">Account</p>
...
//             <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#C8102E] to-[#0891B2] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
//               {user.fullName?.slice(0, 2).toUpperCase() || "PT"}
//             </div>
//             <div className="flex-1 min-w-0">
//               <p className="text-white text-xs font-semibold truncate">{user.fullName || "Patient"}</p>
//               <p className="text-[#4A6080] text-xs truncate">{user.email || ""}</p>
//             </div>
//           </div>
//           <button
//             onClick={handleLogout}
//             className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#C8102E] hover:bg-[#C8102E]/10 transition-all text-left"
//           >
//             <LogOut size={17} />
...
//           <div>
//             <h2 className={`text-xl font-bold tracking-tight ${t.text}`}>Patient Dashboard</h2>
//             <p className={`text-xs ${t.subtext}`}>{formatDate(currentTime)}</p>
//           </div>
//           <div className="flex items-center gap-3">
//             <div className={`flex items-center gap-2 px-3 py-2 rounded-xl border ${t.cardBorder} ${t.inputBg} w-56`}>
//               <Search size={15} className={t.subtext} />
//               <input
//                 placeholder="Search doctors, hospitals…"
//                 className={`bg-transparent text-sm outline-none ${t.text} placeholder:text-slate-400 w-full`}
//               />
//             </div>
//             <button className={`relative w-9 h-9 rounded-xl border ${t.cardBorder} ${t.card} flex items-center justify-center hover:opacity-80`}>
//               <Bell size={16} className={t.text} />
//               <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#C8102E] rounded-full" />
//             </button>
//             <button
//               onClick={() => setDarkMode(!darkMode)}
//               className={`w-9 h-9 rounded-xl border ${t.cardBorder} ${t.card} flex items-center justify-center hover:opacity-80`}
//             >
//               {darkMode ? <Sun size={16} className="text-[#F59E0B]" /> : <Moon size={16} className={t.text} />}
//             </button>
//             <button
//               onClick={handleLogout}
//               className="flex items-center gap-2 px-3 py-2 rounded-xl bg-[#C8102E]/10 text-[#C8102E] text-sm font-semibold hover:bg-[#C8102E]/20 transition-all"
//             >
...
//                 <div>
//                   <p className="text-sm font-bold">Assalam-o-Alaikum, {user.fullName || "Patient"}! 👋</p>
//                   <p className="text-[#4A6080] text-xs mt-0.5">Aapka health portal ready hai. Symptoms check karein ya doctor se milein.</p>
//                 </div>
//               </div>
...
//                     <p className={`text-xs ${t.subtext} mt-0.5`}>Powered by Google Gemini — apne symptoms describe karein</p>
//                   </div>
...
//                     placeholder="Apne symptoms yahan likhein... (e.g. sar dard, bukhar, khansee)"
...
//                     >
//                       <Mic size={14} />
//                       {isListening ? "Sun raha hun…" : "Voice Input"}
//                     </button>
//                     <button
...
//                       <p className="text-xs text-[#92400E]">Ye AI suggestion hai — doctor ki professional advice zaroor lein.</p>
//                     </div>
//                   </div>
//                 )}
//               </div>
...
//                     <p className={`text-xs ${t.subtext} mt-0.5`}>Specialization ke hisaab se filter karein</p>
//                   </div>
...
//                     <p className={`text-xs ${t.subtext} mt-0.5`}>Google Maps se location-based results</p>
//                   </div>
...
//                   <p className="text-[#4A6080] text-xs mt-1">{ambulances.filter(a => a.status === "Available").length} ambulances aapke qareeb available hain</p>
...
//               <div className={`${cardClass} p-5`}>
//                 <div className="flex items-center justify-between mb-4">
//                   <h3 className={`text-sm font-bold ${t.text}`}>Consultation Payments</h3>
//                   <CreditCard size={16} className={t.subtext} />
//                 </div>
//                 <div className="space-y-3">
//                   {pendingPayments.map((pay, i) => (
//                     <div key={i} className={`p-3 rounded-xl border ${t.cardBorder} ${t.soft}`}>
//                       <div className="flex items-center justify-between mb-1">
//                         <p className={`text-xs font-bold ${t.text}`}>{pay.doctor}</p>
...
//                         }`}>{pay.status}</span>
//                       </div>
//                       <p className={`text-xs ${t.subtext}`}>{pay.type} · {pay.date}</p>
//                       <div className="flex items-center justify-between mt-2">
//                         <p className={`text-sm font-bold ${t.text}`}>{pay.amount}</p>
//                         {pay.status === "Pending" && (
//                           <button className="text-xs px-3 py-1.5 rounded-lg bg-[#059669] text-white font-bold hover:opacity-80 transition-opacity">
//                             Pay Now
//                           </button>
//                         )}
//                         {pay.status === "Paid" && (
...
//                   ))}
//                 </div>
//                 <button className={`mt-3 w-full py-2 rounded-xl border ${t.cardBorder} text-xs font-semibold ${t.subtext} hover:opacity-80 transition-opacity`}>
...
//               <div className={`${cardClass} p-5`}>
//                 <div className="flex items-center justify-between mb-4">
//                   <h3 className={`text-sm font-bold ${t.text}`}>My Profile</h3>
//                   <button className={`text-xs text-[#C8102E] font-semibold hover:opacity-80`}>Edit</button>
//                 </div>
//                 <div className="flex items-center gap-3 mb-4">
//                   <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#C8102E] to-[#0891B2] flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
//                     {user.fullName?.slice(0, 2).toUpperCase() || "PT"}
//                   </div>
//                   <div>
//                     <p className={`text-sm font-bold ${t.text}`}>{user.fullName || "Patient"}</p>
//                     <p className={`text-xs ${t.subtext}`}>{user.email || ""}</p>
//                     <span className="text-xs px-2 py-0.5 rounded-full bg-[#DBEAFE] text-[#1E40AF] font-semibold">Patient</span>
//                   </div>
//                 </div>
//                 <div className={`space-y-2 pt-3 border-t ${t.cardBorder}`}>
//                   {[
//                     { label: "Blood Group", value: "A+" },
//                     { label: "Age", value: "28 years" },
//                     { label: "Last Visit", value: "12 days ago" },
//                   ].map((item, i) => (
//                     <div key={i} className="flex items-center justify-between">
//                       <span className={`text-xs ${t.subtext}`}>{item.label}</span>
...
//                   {[
//                     { label: "Check Symptoms", icon: Brain, color: "#C8102E" },
//                     { label: "Find Doctor", icon: Stethoscope, color: "#0891B2" },
//                     { label: "Nearby Hospital", icon: Building2, color: "#7C3AED" },
//                     { label: "Call Ambulance", icon: Ambulance, color: "#059669" },
//                     { label: "Make Payment", icon: CreditCard, color: "#F59E0B" },
//                     { label: "View Reports", icon: FileText, color: "#EC4899" },
//                   ].map((action, i) => {
...
>
  ...
  <div className="p-3 border-t border-[#1E2D45]">
    ...
    >
      ...
      <main className="flex-1 min-w-0 overflow-x-hidden">
        {/* ─── PROFESSIONAL HEADER ─── */}
{/* <div className={`w-full border-b ${t.topbarBorder} ${t.topbar}`}> */}
<div
...
<div className={`hidden md:flex items-center gap-2 px-4 py-2 rounded-2xl border ${t.cardBorder} ${t.inputBg} w-[280px]`}>
  ...
  />
      ...
      <div className="hidden sm:flex items-center gap-2">
        ...
        {/* ─── PROFESSIONAL FOOTER ─── */}
{/* <footer className={`mt-8 border-t ${t.topbarBorder} ${t.topbar}`}> */}
<footer
